import {CARDS_AMOUNT, CARDS_AMOUNT_RENDER, CARDS_AMOUNT_EXTRA, Position, ExtraTitle} from "../consts.js";
import FilmBlockComponent from "./film-block.js";
import FilmsListComponent from "./films-list.js";
import FilmsListExtraComponent from "./films-list-extra.js";
...
console.log(getMoviesArrays(movies).moviesFirst);
